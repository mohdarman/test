<%-- 
    Document   : userLogged
    Created on : 23 Oct, 2019, 12:36:14 AM
    Author     : arman
--%>
...
<head>
		...
		<script src="//maps.googleapis.com/maps/api/js?key=js-9qZHzu2Flc59Eq5rx10JdKERovBlJp3TQ3ApyC4TOa3tA8U7aVRnFwf41RpLgtE7" type="text/javascript"></script>
</head>
<body>
